...
<tr><td>Admin</td><td><input type='checkbox' id='user_edit_is_admin' "+(is_admin?"checked":"")+"></td></tr>\
...
<tr><td colspan=2 class='submit'><input type='submit' class='submit' value='Zapisz'><input id='user_edit_remove' type='button' class='submit' value='Usuń'><input id='user_edit_cancel' type='button' class='submit' value='Anuluj'></td></tr>\
</table>\
</form>\
</div>\
</div>\
